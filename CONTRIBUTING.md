# Contributing to Snuggle Music

Thank you for your interest in contributing to Snuggle Music! This document provides comprehensive guidelines and information for contributors.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/Snuggle-Music.git
   cd Snuggle-Music
   ```
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/iad1tya/Snuggle-Music.git
   ```
...
When contributing to Snuggle Music, it's crucial to handle sensitive information properly:
...
1. Check the [GitHub Discussions](https://github.com/iad1tya/Snuggle-Music/discussions)
...
Thank you for contributing to Snuggle Music!
