# Contributing to Snuggle Musix

Thank you for your interest in contributing to Snuggle Musix! This document provides comprehensive guidelines and information for contributors.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/Snugle-Musix.git
   cd Snugle-Musix
   ```
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/prasanna172605/Snugle-Musix.git
   ```
...
2. Add Android apps with package names:
   - `com.snuggle.music` (release)
   - `com.snuggle.music.debug` (debug)
...
When contributing to Snuggle Musix, it's crucial to handle sensitive information properly:
...
```
app/src/main/java/com/maxrave/snuggle/
...
- **Packages**: lowercase (`com.maxrave.snuggle.ui`)
...
./gradlew test --tests "iad1tya.snuggle.MusicPlayerTest"
...
1. Check the [GitHub Discussions](https://github.com/prasanna172605/Snugle-Musix/discussions)
...
Thank you for contributing to Snuggle Musix!
