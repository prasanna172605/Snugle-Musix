<div align="center">
  <img src="assets/Snuggle-new.png" alt="Snuggle Musix Logo" width="140"/>
  ...
  [![GitHub Release](https://img.shields.io/github/v/release/prasanna172605/Snugle-Musix?style=for-the-badge&color=6f42c1)](https://github.com/prasanna172605/Snugle-Musix/releases)
  [![GitHub Stars](https://img.shields.io/github/stars/prasanna172605/Snugle-Musix?style=for-the-badge&color=e3b341)](https://github.com/prasanna172605/Snugle-Musix/stargazers)
  [![License](https://img.shields.io/github/license/prasanna172605/Snugle-Musix?style=for-the-badge&color=28a745)](LICENSE)
  ...
  <table style="margin: 0 auto; border-collapse: collapse;">
    <tr>
      <td align="center" style="padding: 10px; border: none;">
        ...
        <img src="Screenshots/Homepage.jpeg" alt="Home Screen" width="200" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"/>
      </td>
      <td align="center" style="padding: 10px; border: none;">
        <strong>Music Player</strong><br><br>
        <img src="Screenshots/Music%20Player.jpeg" alt="Music Player" width="200" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"/>
      </td>
      <td align="center" style="padding: 10px; border: none;">
        <strong>Synchronized Lyrics</strong><br><br>
        <img src="Screenshots/Synchronized%20lyrics.jpeg" alt="Synchronized Lyrics" width="200" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"/>
      </td>
    </tr>
    <tr>
      <td align="center" style="padding: 10px; border: none;">
        <strong>Search & Explore</strong><br><br>
        <img src="Screenshots/Search%20and%20Explore.jpeg" alt="Search & Explore" width="200" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"/>
      </td>
      <td align="center" style="padding: 10px; border: none;">
        <strong>Music Library</strong><br><br>
        <img src="Screenshots/Playlist%20%26%20library.jpeg" alt="Music Library" width="200" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"/>
      </td>
      <td align="center" style="padding: 10px; border: none;">
        <strong>Snuggle Find (Recognition)</strong><br><br>
        <img src="Screenshots/Song%20recognition.jpeg" alt="Snuggle Find" width="200" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"/>
      </td>
    </tr>
  </table>
</div>
...
[![Star History Chart](https://api.star-history.com/svg?repos=prasanna172605/Snugle-Musix&type=timeline&legend=top-left)](https://www.star-history.com/#prasanna172605/Snugle-Musix&type=timeline&legend=top-left)
