<div align="center">
  <img src="assets/Snuggle-new.png" alt="Snuggle Music Logo" width="140"/>
  ...
  [![GitHub Release](https://img.shields.io/github/v/release/iad1tya/Snuggle-Music?style=for-the-badge&color=6f42c1)](https://github.com/iad1tya/Snuggle-Music/releases)
  [![GitHub Stars](https://img.shields.io/github/stars/iad1tya/Snuggle-Music?style=for-the-badge&color=e3b341)](https://github.com/iad1tya/Snuggle-Music/stargazers)
  [![License](https://img.shields.io/github/license/iad1tya/Snuggle-Music?style=for-the-badge&color=28a745)](LICENSE)
  [![Telegram](https://img.shields.io/badge/Telegram-Join-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/SnuggleMusicApp)
  ...
  <a href="https://trendshift.io/repositories/20485" target="_blank">
    <img src="https://trendshift.io/api/badge/repositories/20485" alt="SnuggleMusicApp%2FSnuggle-Music | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/>
  </a>

  <br>

  <a href="https://snugglemusic.fun/download">
    <img src="assets/download.png" alt="Download" width="180"/>
  </a>
  &nbsp;
  <a href="https://snugglemusic.fun/obtainium">
...
Snuggle Music delivers a seamless, premium listening experience by leveraging YouTube Music's vast library — without the ads. It adds powerful extras including offline downloads, real-time synchronized lyrics, and environment-aware music recognition.
  ...
  <table style="margin: 0 auto; border-collapse: collapse;">
    ...
    <tr>
      ...
      <td align="center" style="padding: 10px; border: none;">
        ...
        <img src="Screenshots/sc_6.png" alt="Snuggle Find" width="200" style="border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.2);"/>
      </td>
    </tr>
  </table>
</div>
...
Download the latest pre-compiled APK from the [Releases Page](https://github.com/iad1tya/Snuggle-Music/releases/latest).

### Building from Source

1. **Clone the Repository**
   ```bash
   git clone https://github.com/iad1tya/Snuggle-Music.git
   cd Snuggle-Music
   ```
...
4. **Build the Application**
   Snuggle Music has two build variants: **FOSS** (without Google Play Services / Cast) and **GMS** (with Cast support).
...
<div align="center">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;
  <a href="https://t.me/SnuggleMusicApp">
...
If Snuggle Music has been useful to you, consider supporting its development.
...
Snuggle Music stands on the shoulders of several excellent open-source projects. Sincere thanks to:
...
[![Star History Chart](https://api.star-history.com/svg?repos=SnuggleMusicApp/Snuggle-Music&type=timeline&legend=top-left)](https://www.star-history.com/#SnuggleMusicApp/Snuggle-Music&type=timeline&legend=top-left)
