...
If you discover a security vulnerability in Snuggle Music, please report it responsibly:

1. **Do NOT** create a public GitHub issue
2. Email us at: [security@snugglemusic.fun](mailto:security@snugglemusic.fun)
...
Snuggle Music is committed to user privacy:
...
- Email: [security@snugglemusic.fun](mailto:security@snugglemusic.fun)
- GitHub: Create a private security advisory

Thank you for helping keep Snuggle Music secure!
