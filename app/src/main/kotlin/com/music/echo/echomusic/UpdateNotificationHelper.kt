package com.snuggle.music.snugglemusic
...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            "https://nightly.link/SnuggleMusicApp/workflows/nightly.yml/main/snugglemusic-gms-nightly.zip"
        } else {
            "https://github.com/SnuggleMusicApp/Snuggle-Music/releases/download/$versionName/snugglemusic.apk"
        }
