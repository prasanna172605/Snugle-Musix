package com.snuggle.music.snugglemusic.updater.downloadmanager
...
class UpdateDownloadWorker(private val context: Context, workerParams: WorkerParameters) :
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            val downloadFile = if (isZip) File(downloadDir, "snuggle_temp.zip") else File(downloadDir, "snugglemusic.apk")
            ...
            val finalFile = if (isZip) {
                val targetApkFile = File(downloadDir, "snugglemusic.apk")
                var extracted = false
                try {
