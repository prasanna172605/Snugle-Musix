...
object ListenTogetherServers {
    private const val SERVER_JSON_URL = "https://raw.githubusercontent.com/aberrant/Snugle-Musix/refs/heads/main/app/server.json"

    private val _servers = MutableStateFlow(
        listOf(
            ListenTogetherServer(
                name = "Snugle Musix Server",
                url = "wss://aberrant-snuglemusix.hf.space/ws",
                location = "Global",
                operator = "aberrant"
            )
        )
