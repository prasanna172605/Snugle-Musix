...
import com.snuggle.music.eq.data.FilterType
import com.snuggle.music.eq.data.ParametricEQBand
...
class AxionEqViewModel @Inject constructor(
    ...
    private val prefs = context.getSharedPreferences("snuggle_eq_prefs", Context.MODE_PRIVATE)
    ...
    val customProfiles = eqProfileRepository.profiles.map { profiles ->
        profiles.filter { it.isCustom && it.id != "snuggle_tuning" }
