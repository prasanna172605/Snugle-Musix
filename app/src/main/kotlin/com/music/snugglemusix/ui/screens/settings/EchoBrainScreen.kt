...
import com.snuggle.music.engine.EchoBrainEngine
import com.snuggle.music.engine.brain.*
...
fun EchoBrainScreen(
    ...
    isHighlighted = (highlightKey == stringResource(R.string.echo_brain_enable)),
                                        ...
                                        onCheckedChange = { isChecked ->
                                            ...
                                            coroutineScope.launch {
                                                context.dataStore.edit { prefs ->
                                                    prefs[com.snuggle.music.constants.EchoBrainEnabledKey] = isChecked
                                                }
                                            }
                                        }
                                    )
                                ...
                                onClick = { 
                                    ...
                                    scope.launch {
                                        context.dataStore.edit { prefs ->
                                            prefs[com.snuggle.music.constants.EchoBrainEnabledKey] = !isEnabled
                                        }
                                    }
                                }
                            )
