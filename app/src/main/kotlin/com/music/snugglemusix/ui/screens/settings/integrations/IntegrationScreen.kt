...
package com.snuggle.music.ui.screens.settings.integrations
...
import com.snuggle.music.ui.component.IntegrationCard
import com.snuggle.music.ui.component.IntegrationCardItem
...
highlightKey: String? = null) {
    ...
    val (listenBrainzEnabled, onListenBrainzEnabledChange) = com.snuggle.music.utils.rememberPreference(com.snuggle.music.constants.ListenBrainzEnabledKey, false)
    val (listenBrainzToken, onListenBrainzTokenChange) = com.snuggle.music.utils.rememberPreference(com.snuggle.music.constants.ListenBrainzTokenKey, "")
    ...
    Column(
        ...
        com.snuggle.music.ui.component.SwitchPreference(
        ...
        com.snuggle.music.ui.component.PreferenceEntry(
            title = {
                Text(
    ...
    if (showListenBrainzTokenEditor.value) {
        com.snuggle.music.ui.component.TextFieldDialog(
            ...
            extraContent = {
                com.snuggle.music.ui.component.InfoLabel(text = stringResource(R.string.listenbrainz_scrobbling_description))
            },
        )
    }
}
