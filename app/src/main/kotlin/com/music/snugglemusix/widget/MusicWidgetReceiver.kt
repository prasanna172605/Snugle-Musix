...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.snuggle.music.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.snuggle.music.widget.LIKE"
        const val ACTION_NEXT = "com.snuggle.music.widget.NEXT"
        const val ACTION_PREVIOUS = "com.snuggle.music.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.snuggle.music.widget.UPDATE_WIDGET"
    }
}
