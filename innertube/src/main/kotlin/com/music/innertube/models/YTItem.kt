...
import com.music.innertube.utils.ShareConfiguration
...
data class SongItem(
    ...
    override val shareLink: String
        get() = ShareConfiguration.provider.getSongShareUrl(id)
}
...
data class AlbumItem(
    ...
    override val shareLink: String
        get() = ShareConfiguration.provider.getAlbumShareUrl(playlistId)
}
...
data class PlaylistItem(
    ...
    override val explicit: Boolean
        get() = false
    override val shareLink: String
        get() = ShareConfiguration.provider.getPlaylistShareUrl(id)
}
...
data class ArtistItem(
    ...
    override val explicit: Boolean
        get() = false
    override val shareLink: String
        get() = ShareConfiguration.provider.getArtistShareUrl(id)
}
