/**
 * snugglemusic Project (C) 2026
 * Licensed under GPL-3.0 | See git history for contributors
 *
 * JioSaavn audio streaming service.
 * Uses the Melo API (saavn.snugglemusic.fun) which is an open wrapper around JioSaavn.
 *
 * API endpoints used:
    ...
    private val client by lazy {
        HttpClient(CIO) {
            ...
            defaultRequest {
                ...
                headers.append(HttpHeaders.UserAgent, "SnuggleMusic/1.0")
            }
            expectSuccess = false
        }
    }
